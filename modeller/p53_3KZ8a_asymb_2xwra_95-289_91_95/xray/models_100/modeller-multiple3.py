...
class MyModel(automodel):
      def user_after_single_model(self):
        # each model:
        self.rename_segments(segment_ids=('B','B','A','A'), renumber_residues=[91, 300, 91, 300])
...
a = MyModel(env,
            ...
            knowns   = ('3kz8_01A_asymB', '2XWRa_aligned_A', '2XWRa_aligned_B'),     # codes of the templates
            sequence = 'p53_3KZ8_A_asymB_2xwra_91-289')               # code of the target
