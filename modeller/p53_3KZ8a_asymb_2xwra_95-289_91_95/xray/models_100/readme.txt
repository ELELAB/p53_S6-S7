Read me for preparation of 3KZ8 dimer complex from tetramer analysis. 
=======================================================================
...
The input file 3KZ8 was was fetched into a pymol session where:
        ...
        3) Chain A of the protein and chain B from the symmetry mate were exported as a molecule in 3kz8_01A_asymB.pdb 

Part 1: Pymol
=====================
3kz8_01A_asymB.pdb and the template 2XWR_clean_A.pdb were opened into a pymol session where:
        1) The reference structure 2XWR_clean_A.pdb was aligned to the Ca's of 3kz8_01A_asymB.pdb chain A:
           select calpha3KZ8_A,  (name CA) and  chain A and ss S and 3kz8_01A_asymB
           align 2XWR_clean_A, calpha3KZ8_A
           save the aligned 2XWR_clean_A as a molecule called 2XWRa_aligned_A.pdb
        2) The reference structure 2XWR_clean_A.pdb was aligned to the Ca's of 3kz8_01A_asymB.pdb chain B:
           select calpha3KZ8_B,  (name CA) and  chain B and ss S and 3kz8_01A_asymB
...
============================
The Zinc atoms in 3kz8_01A_asymB.pdb were renamed following 2XWR convention, residue number 300 and moved after TER entry of the corresponding chain
